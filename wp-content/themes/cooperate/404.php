...
<main>
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-6 align-self-center">
                <h1>404</h1>
                <h2><?php echo __("UH OH! You're lost.", 'cooperate') ?></h2>
                <p>
                    <?php echo __('The page you are looking for does not exist. How you got here is a mystery. But you can click the button below to go back to the homepage.', 'cooperate') ?>
                </p>
                <button onclick="window.location.href = '<?php echo esc_url(home_url()) ?>'" class="btn green"><?php echo __('HOME', 'cooperate') ?></button>
            </div>
        </div>
    </div>
</main>
